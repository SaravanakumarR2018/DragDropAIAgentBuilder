...
import { CollectionIndexRedirect } from "./CollectionIndexRedirect";
            ...
            >
              ...
              >
                ...
                <Route
                  ...
                  element={
                    <Suspense fallback={<LoadingPage />}>
                      <HomePage key="workspaces" type="workspaces" />
                    </Suspense>
                  }
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <Suspense fallback={<LoadingPage />}>
                      <HomePage key="templates" type="templates" />
                    </Suspense>
                  }
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <Suspense fallback={<LoadingPage />}>
                      <HomePage key="assistant" type="assistant" />
                    </Suspense>
                  }
                />
                <Route
