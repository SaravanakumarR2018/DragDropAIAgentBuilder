...
PLANS: tuple[PlanDefinition, ...] = (
    PlanDefinition(key="starter_pack_monthly", name="Starter", monthly_price_usd="2000", trial_days=7),
    PlanDefinition(key="pro_pack_monthly", name="Pro", monthly_price_usd="5000"),
)
...
#             unit_price=Money(amount=plan.monthly_price_usd, currency_code=CurrencyCode.USD),
#             custom_data={"plan_key": plan.key},
#         )
#     )