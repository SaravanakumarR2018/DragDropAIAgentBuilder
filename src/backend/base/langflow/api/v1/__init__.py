...
from langflow.api.v1.openai_responses import router as openai_responses_router  # ⬅️ From upstream
from langflow.api.v1.organisation_router import router as organisation_router   # ⬅️ From your fork
...
__all__ = [
    ...
    "mcp_router",
    "monitor_router",
    "organisation_router",       # ⬅️ Keep (multi-org)
    "openai_responses_router",   # ⬅️ Keep (upstream)
    "projects_router",
